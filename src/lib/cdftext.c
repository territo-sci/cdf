...
(C) Copyright 1990-2017 NASA/GSFC\012\
...
case BLOCKINGFACTOR_TOO_SMALL:
strcpyX (textPtr,
"BLOCKINGFACTOR_TOO_SMALL: The blocking factor set for the compressed variable is smaller than the default. It is changed but may make data access ineffective.",
CDF_STATUSTEXT_LEN);
break;

case BLOCKINGFACTOR_TOO_SMALL2:
strcpyX (textPtr,
"BLOCKINGFACTOR_TOO_SMALL2: The variable's blocking factor is smaller than the default if it is compressed. The compression is set but may make data access ineffective.",
CDF_STATUSTEXT_LEN);
break;
