...
static char *special2vAttrs[] = {
       "DEPEND_0", "DEPEND_1", "DEPEND_2", "DEPEND_3", "DEPEND_4", "DEPEND_5",
       "LABL_PTR_0", "LABL_PTR_1", "LABL_PTR_2", "LABL_PTR_3", "LABL_PTR_4",
       "COMPONENT_0", "COMPONENT_1", "COMPONENT_2", "COMPONENT_3",
       "OFFSET_0", "OFFSET_1", "OFFSET_2", "OFFSET_3", "OFFSET_4", 
       "DERIVN",   "V_PARENT", "DELTA_PLUS_VAR", "DELTA_MINUS_VAR",
       "EPOCH",    "RANGE_EPOCH", "FORM_PTR", "UNIT_PTR", "SCAL_PTR"
};
...
static long maxRec, varMaxRec, sp, bf, fromRec, toRec, fromRec2, toRec2,
       nRecords, hyperStep;
...
*/
	          ...
	          strcpyX (newVarName, varName, 0);
                ...
                if (usePrefix && !dataOnly)
                  ModifyName (varName, numTokens, prefixes, (int) icountx,
                              newVarName);
                else
                  strcpyX (newVarName, varName, 0);
              }
                ...
                **************************************************************/
                ...
                if (usePrefix && !dataOnly) {
                  if (strcmpIgCase (attrName, dspType) == 1) {
                    changed = FALSE;
                    newValue = (char *) 
                                cdf_AllocateMemory ((size_t)strlen(value)+150,
                                                    FatalError);
                    /**********************************************************
                    ...
                    **********************************************************/
                    ...
                    if (changed)
                      status = CDFlib (PUT_, zENTRY_DATA_, dataTypeX,
                                                           (long) strlen(newValue),
                                                           newValue,
                                       NULL_);
                    else
                      status = CDFlib (PUT_, zENTRY_DATA_, dataTypeX, numElemsX,
                                                           value,
                                       NULL_);
