...
#define CDFdeletezVarRecordsRenumber(id,varNum,sRec,eRec) \
CDFdeleteVarRecordsRenumber(id,1,varNum,sRec,eRec)
...
#define CDFdeleteVarRecordsRenumber(id,zVar,varNum,firstRec,lastRec) \
CDFlib (SELECT_, CDF_, id, \
                 (zVar? zVAR_: rVAR_), varNum, \
...
#define CDFgetLeapSecondLastUpdated(id,lastUpdated) \
CDFlib (SELECT_, CDF_, id, \
...
#define CDFsetLeapSecondLastUpdated(id,lastUpdated) \
CDFlib (SELECT_, CDF_, id, \
        PUT_, CDF_LEAPSECONDLASTUPDATED_, lastUpdated, \
        NULL_)
...
VISIBLE_PREFIX void CDFdataFree PROTOARGs((CDFdata value));
VISIBLE_PREFIX CDFstatus CDFreadgAttrEntry PROTOARGs((
  CDFid id, long attrNum, long entryNum, long *dataType, long *numElms,
  CDFdata *value
));
VISIBLE_PREFIX CDFstatus CDFreadzAttrEntry PROTOARGs((
  CDFid id, long attrNum, long entryNum, long *dataType, long *numElms,
  CDFdata *value
));
...
VISIBLE_PREFIX CDFstatus CDFgetzVarSpec PROTOARGs((
  CDFid id, long varNum, long *dataType, long *numElems,
  long *numDims, long *dimSizes, long *recVary, long *dimsVary 
));
VISIBLE_PREFIX CDFstatus CDFreadzVarPadValue PROTOARGs((
  CDFid id, long varNum, long *dataType, long *numElms, CDFdata *buffer
));
VISIBLE_PREFIX CDFstatus CDFreadzVarAllByVarID PROTOARGs((
  CDFid id, long varNum, long *numRecs, long *dataType, long *numElems,
  long *numDims, long *dimSizes, long *recVary, long *dimsVary, 
  CDFdata *buffer
));
VISIBLE_PREFIX CDFstatus CDFreadzVarDataByVarID PROTOARGs((
  CDFid id, long varNum, long *numRecs, CDFdata *buffer
));
VISIBLE_PREFIX CDFstatus CDFreadzVarRangeDataByVarID PROTOARGs((
  CDFid id, long varNum, long strNum, long stpNum, CDFdata *buffer
));
...
VISIBLE_PREFIX CDFstatus CDFreadzVarAllByVarName PROTOARGs((
  CDFid id, char *varName, long *numRecs, long *dataType, long *numElems,
  long *numDims, long *dimSizes, long *recVary, long *dimsVary, 
  CDFdata *buffer
));
VISIBLE_PREFIX CDFstatus CDFreadzVarDataByVarName PROTOARGs((
  CDFid id, char *varName, long *numRecs, CDFdata *buffer
));
VISIBLE_PREFIX CDFstatus CDFreadzVarRangeDataByVarName PROTOARGs((
  CDFid id, char *varName, long strNum, long stpNum, CDFdata *buffer
));
...
VISIBLE_PREFIX CDFstatus CDFdeleteRecordsForAll PROTOARGs((
  CDFid id, long startRec, long endRec
));
...
VISIBLE_PREFIX long long computeTT2000withBasedLeapDay PROTOARGs((
  long yy, long mm, long dd, long hh, long mn, long ss, long ms,
  long us, long ns, int yymmdd
));
VISIBLE_PREFIX void breakdownTT2000withBasedLeapDay PROTOARGs((
  long long tt2000, int yymmdd, 
  long *yy, long *mm, long *dd, long *hh, long *mn, long *ss,
  long *ms, long *us, long *ns
));
VISIBLE_PREFIX long long parseTT2000withBasedLeapDay PROTOARGs((
  char *tt2000, int yymmdd
));
VISIBLE_PREFIX void encodeTT2000withBasedLeapDay PROTOARGs((
  long long tt2000,
  int yymmdd,
  char *string
));
